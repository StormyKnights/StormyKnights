...
class PieceTest < ActiveSupport::TestCase
  ...
  test "valid rook move" do
    ...
    assert_equal true, rook1.valid_move?(0,5) #move up 5 spaces
  ...
  #  rook1 = g.find_by(type: 'Rook', color: 'white', x_coordinates: 0, y_coordinates: 0)
    
  #  assert_equal true, rook1.occupied?(0, 0)
   # assert_equal true, rook1.obstructed?([3, 0])
 # end
end
